...
contract StrategyWault is Ownable, ReentrancyGuard, Pausable {
    ...
    function _farm() internal {
        ...
        IXswapFarm(farmContractAddress).deposit(pid, wantAmt, true);
    }
        ...
        returns (uint256)
    {
        ...
        if (isAutoComp) {
            IXswapFarm(farmContractAddress).withdraw(pid, _wantAmt, true);
        }
    ...
    function _earn() internal {
        ...
        // Harvest farm tokens
        IXswapFarm(farmContractAddress).withdraw(pid, 0, true);
